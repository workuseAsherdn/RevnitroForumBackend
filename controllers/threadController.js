...
const getThread = async (req, res) => {
  ...
  try {
    ...
    if (searchTerm) {
      ...
      query = Thread.find({
        $or: [
          ...
          { authorIdentity: { $regex: searchTermWithoutAt, $options: "i" } },
    ...
    // if (searchTerm) {
    //   // Remove "@" symbol from the search term
    //   const searchTermWithoutAt = searchTerm.replace("@", "");

    //   query = Thread.find({
    //     $or: [
    //       { title: { $regex: searchTermWithoutAt, $options: "i" } },
    //       { author: { $regex: searchTermWithoutAt, $options: "i" } },
    //       {
    //         authorIdentity: {
    //           $regex: new RegExp(`.*${searchTermWithoutAt}.*`, "i"),
    //         },
    //       },
    //       { content: { $regex: searchTermWithoutAt, $options: "i" } },
    //       {
    //         highlightedContent: { $regex: searchTermWithoutAt, $options: "i" },
    //       },
    //     ],
    //   });
    // }
